(function () {
  ...
  templates["filmSelection.hbs"] = template({
    1: function (container, depth0, helpers, partials, data) {
      ...
      return (
        ...
        alias4(
          ((helper =
            (helper =
              lookupProperty(helpers, "poster_href") ||
              (depth0 != null
                ? lookupProperty(depth0, "poster_href")
                : depth0)) != null
              ? helper
              : alias2),
        ...
        alias4(
          ((helper =
            (helper =
              lookupProperty(helpers, "rating") ||
              (depth0 != null ? lookupProperty(depth0, "rating") : depth0)) !=
            null
              ? helper
              : alias2),
          typeof helper === alias3
    ...
    main: function (container, depth0, helpers, partials, data) {
      ...
      return (
        "<div class='filmSelection'>\n  <div class='filmSelection_name'>\n    " +
        container.escapeExpression(
          ((helper =
            (helper =
              lookupProperty(helpers, "collection_name") ||
              (depth0 != null
                ? lookupProperty(depth0, "collection_name")
                : depth0)) != null
              ? helper
        ...
        ((stack1 = lookupProperty(helpers, "each").call(
          alias1,
          depth0 != null ? lookupProperty(depth0, "films") : depth0,
          {
            name: "each",
            hash: {},
