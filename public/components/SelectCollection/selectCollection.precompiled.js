...
templates['selectCollection.hbs'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <div class=\"selectCollection-frame-list\">\n          <p class=\"selectCollection-frame-list-header\"> "
    ...
    + "</p>\n"
    + ((stack1 = lookupProperty(helpers,"each").call(alias1,(depth0 != null ? lookupProperty(depth0,"collection_items") : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":14,"column":10},"end":{"line":19,"column":19}}})) != null ? stack1 : "")
    + "        </div>\n";
  ...
  return "            <p\n              class=\"selectCollection-frame-list-item\"\n              data-section=\""
  ...
  return "<div class=\"selectCollection\">\n  <div class=\"selectCollection-frame\">\n    <div class=\"selectCollection-frame-header\">\n      <img\n        class=\"selectCollection-frame-img\"\n        src=\"../../icons/arrow_left.svg\"\n      />\n      <p class=\"selectCollection-frame-header-name\"> MovieGate</p>\n    </div>\n    <div class=\"selectCollection-frame-lists\">\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"collections") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":11,"column":6},"end":{"line":21,"column":15}}})) != null ? stack1 : "")
    + "    </div>\n  </div>\n</div>";
},"useData":true});
})();